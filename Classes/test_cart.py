...
class TestShoppingCart(unittest.TestCase):
    ...
    def test_values(self):
        ...
        self.assertRaises(ValueError, self.cart1.add_items,"Espresso",-1)
        self.assertRaises(ValueError, self.cart1.add_items,"Not an item",1)
        self.assertRaises(ValueError, self.cart2.add_items,"New York Cheesecake", 4)
        self.assertRaises(ValueError, self.cart1.remove_items,"Item not in cart", 1)
        self.assertRaises(ValueError, self.cart2.remove_items,"Espresso", 10) #remove more espressos than in cart
        self.assertRaises(ValueError, self.cart1.set_reservation,"Saturday","1:00","AM")
        self.assertRaises(ValueError, self.cart1.set_reservation,"Monday", "4:00", "AM")
        self.assertRaises(ValueError, self.cart1.set_reservation,"twensday", "4:00","PM")
