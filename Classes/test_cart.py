...
class TestShoppingCart(unittest.TestCase):
    def setUp(self):
        ...
        self.cart2 = ShoppingCart("Yariel Mercado")
    ...
    def test_types(self):
        ...
        self.assertRaises(TypeError, self.cart1.remove_items, 1)
    ...
    def test_values(self):
        ...
        self.assertRaises(ValueError, self.cart2.add_items,"Espresso",-1)
        self.assertRaises(ValueError, self.cart2.add_items,"Not an item",1)
        self.assertRaises(ValueError, self.cart2.add_items,"New York Cheesecake", 4)
        self.assertRaises(ValueError, self.cart2.add_items, "americano", 2) # theres already 10 americanos, the max amount of items you can have
        self.assertRaises(ValueError, self.cart2.remove_items,"Item not in cart", 1)
        self.assertRaises(ValueError, self.cart2.remove_items,"Espresso", 10) #remove more espressos than in cart
        self.assertRaises(ValueError, self.cart2.remove_items,"Espresso", 20) #remove more espressos than in cart
        self.assertRaises(ValueError, self.cart2.set_reservation,"Saturday","1:00","AM")
        self.assertRaises(ValueError, self.cart2.set_reservation,"Monday", "4:00", "AM")
        self.assertRaises(ValueError, self.cart2.set_reservation,"Sunday", "12:00", "AM")
        self.assertRaises(ValueError, self.cart2.set_reservation,"twensday", "4:00","PM")
        self.assertRaises(ValueError, self.cart2.set_reservation,"Monday","100:00", "AM")
        self.assertRaises(ValueError, self.cart2.set_reservation, "Monday", "10:00", "MM")
